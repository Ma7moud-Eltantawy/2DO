  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<Database_prov>(
      builder: (context,prov,ch)=>FutureBuilder(
        ...
        builder:(context,AsyncSnapshot<List<TaskModel>> snapshot)=>!snapshot.hasData?Center(child: Text("no tasks"),): Scaffold(
          appBar: _appBar(),
          body: Column(
            children: [
              _calender(),
              ...
              Expanded(child: DateBar(dt:_selectedDate,)),
              showTasks(
                  context: context,
                  tasks:snapshot.data!.where((element) {
                    ...
                    print(dateTime);
                    return DateFormat.yMMMd().format(_selectedDate)==DateFormat.yMMMd().format(dateTime);
                  }).toList(),
